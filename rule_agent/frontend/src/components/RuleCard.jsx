...
import { getRelatedRules } from '../api.js'
...
const CATEGORY_COLORS = {
  completeness: { bg: 'rgba(99,102,241,0.08)',   border: 'rgba(99,102,241,0.22)',  color: '#818CF8' },
  uniqueness:   { bg: 'rgba(99,102,241,0.06)',   border: 'rgba(99,102,241,0.18)',  color: '#A5B4FC' },
  validity:     { bg: 'rgba(99,102,241,0.08)',   border: 'rgba(99,102,241,0.22)',  color: '#818CF8' },
  consistency:  { bg: 'rgba(99,102,241,0.06)',   border: 'rgba(99,102,241,0.18)',  color: '#A5B4FC' },
  accuracy:     { bg: 'rgba(99,102,241,0.10)',   border: 'rgba(99,102,241,0.28)',  color: '#6366F1' },
  timeliness:   { bg: 'rgba(99,102,241,0.06)',   border: 'rgba(99,102,241,0.18)',  color: '#A5B4FC' },
  conformity:   { bg: 'rgba(99,102,241,0.08)',   border: 'rgba(99,102,241,0.22)',  color: '#818CF8' },
}
...
function getCatStyle(cat) {
  const fallback = { bg: 'rgba(99,102,241,0.06)', border: 'rgba(99,102,241,0.18)', color: '#A5B4FC' }
...
export default function RuleCard({ rule, kbId, onAskAboutRule, onRuleSelected }) {
  ...
  useEffect(() => {
    if (!rule?.rule_id || !kbId) return
    setRelatedRules([])
    getRelatedRules(kbId, rule.rule_id)
