...
class DCalendarOperation(BaseOperation):
    """Reads the calendar source repository via DataIO and transforms it into a standardized date dimension with date, month, week, year, year-month, and year-week keys."""
