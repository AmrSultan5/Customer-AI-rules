...
class ValidateSpecialCharactersOperation(BaseOperation):
    """Validates that a text field contains only permitted characters for the customer's country, applying country-specific allowed character sets and paired-character balance rules."""
    ...
    def transform(self, ctx: TransformationContext) -> Optional[DataFrame]:
        ...
        country_rules = {
            ...
            "Rule_14": {"countries": {"PL"}, "chars": r"ąĄćĆęĘłŁńŃóÓśŚźŹżŻ&\":;!+_–=>‚˝´¨”“„~"},
