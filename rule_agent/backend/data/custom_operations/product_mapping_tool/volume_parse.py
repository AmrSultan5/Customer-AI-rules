...
class VolumeParseOperation(BaseOperation):
    """Parses a product name text field using token-based pattern matching to extract volume or weight (e.g. '330ml', '1.5l'), returning the volume, sales unit, and cleaned product name."""
