...
class MinHashLSHSimilarityOperation(BaseOperation):
    """Uses MinHash LSH approximate nearest-neighbour search to find the best-matching value from a reference dataset within a configurable Jaccard similarity threshold."""
