...
class GenerateFlavoursOperation(BaseOperation):
    """Identifies the flavour name for each product by matching n-gram tokens from the product name against a SAP reference table, using weighted voting across multiple n-gram sizes."""
